import { selectDarwinBash, selectLinuxBash } from "../src/bashSelection.js";
import { DARWIN_BASH_VARIANTS, LINUX_BASH_VARIANTS } from "../src/constants.js";
import { OsReleaseInfo } from "../src/types.js";
...
describe("selectLinuxBash", () => {
  ...
  it("prefers exact version match when id is present", () => {
    const info: OsReleaseInfo = { id: "ubuntu", idLike: ["debian"], versionId: "24.04.1" };
