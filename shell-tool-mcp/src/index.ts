...
import { resolveBashPath } from "./bashSelection.js";
import { readOsRelease } from "./osRelease.js";
import { resolveTargetTriple } from "./platform.js";
...
const childResult = await new Promise<{ type: "signal"; signal: NodeJS.Signals } | { type: "code"; exitCode: number }>(
  (resolve) => {
