...
use crate::posix::mcp_exec_policy::ExecPolicy;
use crate::posix::mcp_exec_policy::McpExecPolicy;
...
impl ExecTool {
    ...
    async fn shell(
        ...
        let policy = Arc::new(McpExecPolicy::new(self.policy, context));
        let escalate_server = EscalateServer::new(self.bash_path.clone(), policy);
